...
const message = process.env.POLLY_DEVELOPMENT_MODE == 'true' ? undefined : await (await client.channels.fetch('939984413733847130') as TextChannel).messages.fetch('940018823791280178')
const collector = message ? message.createReactionCollector({ dispose: true }) : undefined
