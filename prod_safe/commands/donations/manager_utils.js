...
const wipeConf = new Array();
const embedColor = '#f5cb42';
...
export async function execute(interaction, client) {
    ...
    switch (interaction.options.getSubcommand()) {
        case 'update':
            ...
            if (!hasPerms(m, interaction.options.getString('type'))) {
                ...
                switch (interaction.options.getString('action')) {
                    case 'add':
                        await donos.addTo(interaction.options.getUser('user').id, interaction.options.getString('type'), interaction.options.getInteger('amount'), m.id);
                        ...
                        break;
                    case 'remove':
                        await donos.takeFrom(interaction.options.getUser('user').id, interaction.options.getString('type'), interaction.options.getInteger('amount'), m.id);
                        ...
                        break;
                    case 'set':
                        await donos.setDono(interaction.options.getUser('user').id, interaction.options.getString('type'), interaction.options.getInteger('amount'), m.id);
...
//# sourceMappingURL=manager_utils.js.map